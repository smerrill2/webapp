        ...
        >
          <Card className="bg-white/10 backdrop-blur-lg border-green-500/20">
            ...
            <CardContent className="prose prose-invert max-w-none">
              ...
              <h2 className="text-xl font-semibold mt-6 mb-4">PERSONAL AND NON-PERSONAL INFORMATION</h2>
              <p>
                Our Privacy Policy identifies how we treat your personal and non-personal information.
              </p>

              <h2 className="text-xl font-semibold mt-6 mb-4">WHAT IS NON-PERSONAL INFORMATION AND HOW IS IT COLLECTED AND USED?</h2>
              <p>
              ...
              <h2 className="text-xl font-semibold mt-6 mb-4">What is personal information and how is it collected?</h2>
              <p>
              ...
              <h2 className="text-xl font-semibold mt-6 mb-4">ARE COOKIES OR OTHER TECHNOLOGIES USED TO COLLECT PERSONAL INFORMATION?</h2>
              <p>
ely assigned to you and can only be read by a web server in the domain that issued the cookie to you.
              </p>
              <p>
