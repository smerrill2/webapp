...
const PrivacyPage: React.FC = () => {
  return (
    <main className="container mx-auto px-4 py-16">
      ...
      >
        <Card className="bg-white backdrop-blur-lg border-pink-500/20">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-black">LawnLogic Privacy Policy</CardTitle>
          </CardHeader>
          <CardContent className="prose max-w-none">
            ...
            <h2 className="text-xl font-semibold mt-6 mb-4 text-black">PERSONAL AND NON-PERSONAL INFORMATION</h2>
            <p className="text-black">
              Our Privacy Policy identifies how we treat your personal and non-personal information.
            </p>

            <h2 className="text-xl font-semibold mt-6 mb-4 text-black">WHAT IS NON-PERSONAL INFORMATION AND HOW IS IT COLLECTED AND USED?</h2>
            <p className="text-black">
            ...
            <h2 className="text-xl font-semibold mt-6 mb-4 text-black">What is personal information and how is it collected?</h2>
            <p className="text-black">
            ...
            <h2 className="text-xl font-semibold mt-6 mb-4 text-black">ARE COOKIES OR OTHER TECHNOLOGIES USED TO COLLECT PERSONAL INFORMATION?</h2>
            <p className="text-black">
