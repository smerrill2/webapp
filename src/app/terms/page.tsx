        ...
        >
          <Card className="bg-white/10 backdrop-blur-lg border-green-500/20">
            ...
            <CardContent className="prose prose-invert max-w-none">
              ...
              <p>
                This website (the &quot;Site&quot;) is owned and operated by LawnLogic d/b/a &quot;lawnlogic.com&quot; (&ldquo;COMPANY,&rdquo; &ldquo;we,&rdquo; or &ldquo;us&rdquo;). By using the Site, you agree to be bound by these Terms of Service and to use the Site in accordance with these Terms of Service, our <a href="/" className="text-blue-400">Privacy Policy</a>, and any additional terms and conditions that may apply to specific sections of the Site or to products and services available through the Site or from COMPANY. Accessing the Site, in any manner, whether automated or otherwise, constitutes use of the Site and your agreement to be bound by these Terms of Service.
              </p>
              <p>
