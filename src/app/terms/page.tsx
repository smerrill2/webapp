        ...
        >
          <Card className="bg-white/10 backdrop-blur-lg border-green-500/20">
            ...
            <CardContent className="prose prose-invert max-w-none">
              ...
              <p>
                This website (the "Site") is owned and operated by LawnLogic d/b/a "lawnlogic.com" (“COMPANY,” “we,” or “us”). By using the Site, you agree to be bound by these Terms of Service and to use the Site in accordance with these Terms of Service, our <a href="/privacy-policy" className="text-blue-400">Privacy Policy</a>, and any additional terms and conditions that may apply to specific sections of the Site or to products and services available through the Site or from COMPANY. Accessing the Site, in any manner, whether automated or otherwise, constitutes use of the Site and your agreement to be bound by these Terms of Service.
              </p>
              <p>
              ...
              <p>
                These Terms of Service shall be governed by and construed in accordance with the laws of the State of **[Your State]**, and any dispute shall be subject to binding arbitration in **[Your State]**. If any provision of this agreement shall be unlawful, void, or for any reason unenforceable, then that provision shall be deemed severable from this agreement and shall not affect the validity and enforceability of any remaining provisions.
              </p>
