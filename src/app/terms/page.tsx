// src/app/pages/TermsOfServicePage.tsx
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        >
          <Card className="bg-white/10 backdrop-blur-lg border-green-500/20">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-white">LawnLogic Terms of Service</CardTitle>
            </CardHeader>
            <CardContent className="prose prose-invert max-w-none">
              
              <h2 className="text-xl font-semibold mt-6 mb-4">General</h2>
              <p>
                This website (the "Site") is owned and operated by LawnLogic d/b/a "lawnlogic.com" (&ldquo;COMPANY,&rdquo; &ldquo;we,&rdquo; or &ldquo;us&rdquo;). By using the Site, you agree to be bound by these Terms of Service and to use the Site in accordance with these Terms of Service, our <a href="/privacy-policy" className="text-blue-400">Privacy Policy</a>, and any additional terms and conditions that may apply to specific sections of the Site or to products and services available through the Site or from COMPANY. Accessing the Site, in any manner, whether automated or otherwise, constitutes use of the Site and your agreement to be bound by these Terms of Service.
              </p>
              <p>
              ...
              <h3 className="text-lg font-semibold mt-4 mb-2">Our Limited License to You</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold mt-4 mb-2">Your License to Us</h3>
              <p>
                ...
                <ol className="list-decimal list-inside mt-2">
                  <li>
                    <strong>Ownership:</strong> (i) that you are the owner of the material, or are making your posting or submission with the express consent of the owner of the material; and 
                  </li>
                  <li>
                    <strong>Age:</strong> (ii) that you are thirteen years of age or older.
                  </li>
                </ol>
              </p>
              <p>
              ...
              <h3 className="text-lg font-semibold mt-4 mb-2">Limitations on Linking and Framing</h3>
              <p>
                You may establish a hypertext link to the Site so long as the link does not state or imply any sponsorship of your site by us or by the Site. However, you may not, without our prior written permission, frame or inline link any of the content of the Site, or incorporate into another website or other service any of our material, content, or intellectual property.
              </p>

              <h2 className="text-xl font-semibold mt-6 mb-4">Disclaimers</h2>
              <p>
              ...
              <h2 className="text-xl font-semibold mt-6 mb-4">Online Commerce</h2>
              <p>
              ...
              <p>
                If payment for a service is declined, our system will automatically disable access to our premium materials. (We understand. This usually happens because a credit card expires.) We want to help restore your access, so we’ll make every attempt to contact you to help resolve this issue. Once the billing issue is resolved, we’ll restore access.
              </p>

              <h2 className="text-xl font-semibold mt-6 mb-4">Interactive Features</h2>
              <p>
              ...
              <h2 className="text-xl font-semibold mt-6 mb-4">Registration</h2>
              <p>
                To access certain features of the Site, we may ask you to provide certain demographic information including your gender, year of birth, zip code, and country. In addition, if you elect to sign up for a particular feature of the Site, such as chat rooms, web logs, or bulletin boards, you may also be asked to register with us on the form provided, and such registration may require you to provide personally identifiable information such as your name and email address. You agree to provide true, accurate, current, and complete information about yourself as prompted by the Site’s registration form. If we have reasonable grounds to suspect that such information is untrue, inaccurate, or incomplete, we have the right to suspend or terminate your account and refuse any and all current or future use of the Site (or any portion thereof). Our use of any personally identifiable information you provide to us as part of the registration process is governed by the terms of our <a href="/privacy-policy" className="text-blue-400">Privacy Policy</a>.
              </p>

              <h2 className="text-xl font-semibold mt-6 mb-4">Passwords</h2>
              <p>
              ...
              <h2 className="text-xl font-semibold mt-6 mb-4">Refund Policy</h2>
              <p>
                Your purchase of a product or service or ticket to an event may or may not provide for any refund. Each specific product, service, event, or course will specify its own refund policy.
              </p>

              <h2 className="text-xl font-semibold mt-6 mb-4">Other</h2>
              <p>
                The Digital Millennium Copyright Act of 1998 (the “DMCA”) provides recourse for copyright owners who believe that material appearing on the Internet infringes their rights under the U.S. copyright law. If you believe in good faith that materials hosted by COMPANY infringe your copyright, you, or your agent may send to COMPANY a notice requesting that the material be removed or access to it be blocked. Any notification by a copyright owner or a person authorized to act on its behalf that fails to comply with requirements of the DMCA shall not be considered sufficient notice and shall not be deemed to confer upon COMPANY actual knowledge of facts or circumstances from which infringing material or acts are evident. If you believe in good faith that a notice of copyright infringement has been wrongly filed against you, the DMCA permits you to send to COMPANY a counter-notice. All notices and counter notices must meet the then-current statutory requirements imposed by the DMCA; see <a href="http://www.loc.gov/copyright" className="text-blue-400">http://www.loc.gov/copyright</a> for details. COMPANY’s Copyright Agent for notice of claims of copyright infringement or counter notices can be reached as follows: <a href="mailto:contact@lawnlogic.com" className="text-blue-400">contact@lawnlogic.com</a>
              </p>
              <p>
                This Agreement shall be binding upon and inure to the benefit of COMPANY and our respective assigns, successors, heirs, and legal representatives. Neither this Agreement nor any rights hereunder may be assigned without the prior written consent of COMPANY. Notwithstanding the foregoing, all rights and obligations under this Agreement may be freely assigned by COMPANY to any affiliated entity or any of its wholly owned subsidiaries.
              </p>
              <p>
                These Terms of Service shall be governed by and construed in accordance with the laws of the State of <strong>[Your State]</strong>, and any dispute shall be subject to binding arbitration in <strong>[Your State]</strong>. If any provision of this agreement shall be unlawful, void, or for any reason unenforceable, then that provision shall be deemed severable from this agreement and shall not affect the validity and enforceability of any remaining provisions.
              </p>
              ...
              <p>
                If you have any questions or concerns regarding our Terms of Service, please direct them to: <a href="mailto:contact@lawnlogic.com" className="text-blue-400">contact@lawnlogic.com</a>
              </p>

              <p className="mt-8">
                © 2024 LawnLogic. All rights reserved.
              </p>
            </CardContent>
          </Card>
        </motion.div>
